                  ...
                  <div class="card rounded-0 mb-0 px-2">
                    ...
                    <div class="card-content">
                      <div class="card-body pt-1">
                        <form action="<?php echo base_url('admin/login/recuperar'); ?>" method="post" style="padding-bottom:2em;">
                          ...
                          <button type="submit" class="btn btn-primary float-right btn-inline waves-effect waves-light">Nova senha</button>
                        </form>
                      </div>
                    </div>
