                  ...
                  <div class="card rounded-0 mb-0 px-2">
                    ...
                    <div class="card-content">
                      <div class="card-body pt-1">
                        <form action="" method="post" style="padding-bottom:2em;">
                          ...
                          <a href="<?php echo base_url(''); ?>" class="btn btn-outline-primary float-left btn-inline waves-effect waves-light">Voltar</a>
                          <button type="submit" class="btn btn-primary float-right btn-inline waves-effect waves-light">Recuperar senha</button>
                        </form>
                      </div>
                    </div>
